        ...
        <div class="main-max-width">
            <div class="page-title-content">
                ...
                <ul class="page-breadcrumb align-items-center list-unstyle">
                    ...
                    <li class="primery-link"><?php echo ($categoryName); ?> Programs</li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <?php else: ?>
                    <?php foreach ($courses as $course): ?>
                        ...
                        $specializationQuery = "
                            ...
                            WHERE Sub_Category_ID  = $subCategoryID AND Status = 1";
                        $specializationResult = mysqli_query($conn, $specializationQuery);
                        $specialization = mysqli_fetch_assoc($specializationResult);
                        $hasSpecialization = $specialization['SpecializationCount'] > 0;
