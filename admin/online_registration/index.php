            ...
            <div class="col-xl-12">
                <div class="card dz-card" id="accordion-four">
                    <div class="card-header flex-wrap d-flex justify-content-between">
                        <div>
                            <h4 class="card-title">online_registration</h4>
                        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        var table = $('#blogs-table').DataTable({
            'processing': true,
            'ajax': {
                'url': '/admin/app/online_registration/server',
                'type': 'POST'
            },
            'columns': [{
                    data: 'No'
...

                {
                    ...
                    render: function(data, type, row) {
                        return '<div class="ms-auto"><a href="javascript:void(0);" onclick="edit(&#39;online_registration&#39;, &#39;' + data + '&#39, &#39;md&#39;)" class="btn btn-primary btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a><a href="javascript:void(0);" onclick="destroy(&#39;online_registration&#39;, &#39;' + data + '&#39)" class="btn btn-danger btn-xs sharp"><i class="fa fa-trash"></i></a></div>';
                    },
                    visible: true
                },
                ...
                //     data: 'ID',
                //     render: function(data, type, row) {
                //         return '<div class="ms-auto"><a href="javascript:void(0);" onclick="destroy(&#39;online_registration&#39;, &#39;' + data + '&#39)" class="btn btn-danger btn-xs sharp"><i class="fa fa-trash"></i></a></div>';
                //     },
                //     visible: true
                // }
    ...
    window.location.href = '/admin/app/online_registration/downloadexcel.php';
}
