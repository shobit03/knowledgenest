                        ...
                        <div id="add_new_images">
                            ...
                            foreach ($existingImages as  $image) { $i++; ?>
                                <div class="input-group mb-3">
                                    ...
                                    <input type="file" class="form-control image-upload"  id="photo_<?=$i ?>" onchange="fileValidation('photo_<?=$i ?>')" accept="image/png, image/jpg, image/jpeg, image/svg,image/avif" name="new_images[]"multiple>
