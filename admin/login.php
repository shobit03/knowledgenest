...
<body class="vh-100">
  <div class="page-wraper">
    ...
    <div class="browse-job login-style3">
      <!-- Coming Soon -->
      <!-- <div class="bg-img-fix overflow-hidden" style="background:#fff url(/admin/admin-assets/images/background/bg14.jpg); height: 100vh;"> -->
        <div class="row gx-0">
          ...
          <div class="col-xl-8 col-lg-7 col-md-6">
            <img src="/admin/admin-assets/images/background/bg9.jpg" alt="bg image" class="p-10" width="900" height="650" >
          </div>
        </div>
      </div>
