...
<title>School Of Ayurvedic Medical And Research Center </title>
    ...
    <div class="container">
        <div class="main-max-width">
            <div class="page-title-content">
                <h2>School Of Ayurvedic Medical And Research Center</h2>
                <ul class="page-breadcrumb align-items-center list-unstyle">
                    <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item"></li>
                    <li class="primery-link">School Of Ayurvedic Medical And Research Center</li>
                </ul>
                ...
                <div class="col-lg-12">
                    <ul class="nav nav-pills mb-3 d-flex gap-3 p-4 flex-row justify-content-center courses-dynamic-section mb-4 rounded-5" id="pills-tab" role="tablist">
                        <li class="nav-item list-unstyle" role="presentation">
                            <button class="nav-link active text-black" id="BAMS" data-bs-toggle="pill" data-bs-target="#BAMScourse" type="button" role="tab" aria-controls="B.pharma" aria-selected="true">BAMS(Bachelor of Ayurvedic Medicine and Surgery)</button>
                        </li>
                    ...
                    <div class="tab-content" id="pills-tabContent">
                        <div class="tab-pane fade show active" id="BAMScourse" role="tabpanel" aria-labelledby="BAMS">
                            <div class="row">
                                    ...
                                    <div class="single-courses-box mb-25 box-shadow-2">
                                        <div class="image mb-20 position-relative">
                                            <a href="course-details.php" class="d-block">
                                                <img src="./assets/img/BAMS(Bachelor of Ayurvedic Medicine and Surgery).jpg" class="rounded-3" alt="image">
                                            </a>
                                        </div>
                                        <div class="content">
                                            <h3 class="mb-15 fs-20 text-center"><a href="blog-details.php">Bachelor of Ayurvedic Medicine and Surgery</a></h3>
                                        ...
                                        <div class="d-flex justify-content-end p-3">
                                            <button class="border-0 rounded-3 px-4 duration text-white">5 YEARS</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
