        ...
        <div class="main-max-width">
            <div class="page-title-content">
                ...
                <ul class="page-breadcrumb align-items-center list-unstyle">
                    ...
                    <li class="primery-link">School Of Education</li>
                </ul>
                ...
                <div class="col-lg-12 ">
                    <ul class="nav nav-pills mb-3 d-flex gap-3 p-4  flex-row justify-content-center courses-dynamic-section mb-4 rounded-5" id="pills-tab" role="tablist">
                        <li class="nav-item list-unstyle" role="presentation">
                            <button class="nav-link active text-black" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">B. ED(
                                Bachelor of Education)</button>
                        </li>
                        <li class="nav-item list-unstyle courses-card" role="presentation">
                            <button class="nav-link rounded-3 p-2 border-0 bg-transparent text-black" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Diploma of Elementary Education</button>
                        </li>
                                    ...
                                    <div class="single-courses-box mb-25  box-shadow-2">
                                        <div class="image mb-20 position-relative">
                                            <a href="course-details.php" class="d-block">
                                                <img src="./assets/img/B. ED..png" class="rounded-3"  alt="image">
                                            </a>
                                        </div>
                                        <!-- <div class="content">
                            ...
                            <div class="row">
                                <div class="col-lg-6 mx-auto col-sm-4" id="pills-home" aria-labelledby="pills-home-tab">
                                    <div class="single-courses-box mb-25 box-shadow-2">
                                        <div class="image mb-20 position-relative">
                                            <a href="course-details.php" class="d-block">
                                                <img src="assets/img/Diploma of Elementary Education.webp" class="rounded-3" alt="image">
                                            </a>
                                        </div>
